...
## More Information
For the more interested reader, who wants to explore the project further, discover addiotional plots, and extra features, the whole explainer notebook is hosted at [**Deepnote**](https://deepnote.com/@maria-fogh/SocialDataProject2022-61ec0a5b-e327-402f-95c1-91c4aeb91c25), or by simply clicking on the *page icon* in the footer. 
Likewise the Github repository for this project, as well as the traffic data can be found at our [**Github**](https://github.com/LasseBredmose/social_data_2022_project), or by simply clicking the *github/device icon* in the footer. 
